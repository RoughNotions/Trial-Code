...
@Test
...

    {
		...
		System.out.println("finding text of xpath");
		select_Dropdown_wait_temp("scopeFor", "/html/body/div/div[3]/div[2]/div[1]/div/div/div[2]/div[3]/table/tbody/tr/td[2]/select/option[2]", "ACCOUNTHOLDERNAMEPATTERN_VEL");
        Thread.sleep(2000);
...
public static void select_Dropdown_wait_temp(String Dropdown_ID, String XPATH_of_list, String List_value)
{
		...
		System.out.println("dropdown value: "+driver.findElement(By.id(Dropdown_ID)).getText());
...
@Test(description = "To verify negative check for account holder name")
...

	{
		...
		// enter in -ve value		
		input("checkValue", Excel.getData("Resourses\\Data\\API_Data_Global.xlsx", "Sheet1",3, 34));
...
@Test(description = "To verify global AIFP velocity check ") 
...

    {
		...
		// enter global in check type
		select_xpath("/html/body/div/div[3]/div[2]/div/div[4]/table/tbody/tr/td/div[2]/div/div/div/div/table/tbody/tr/td/div/div/div[3]/div[3]/div/table/tbody/tr[2]/td[3]/div/div/span");
		input("1_config_value", "1");
		select_xpath("/html/body/div/div[3]/div[2]/div/div[4]/table/tbody/tr/td/div[2]/div/div/div/div/table/tbody/tr/td/div/div/div[3]/div[3]/div/table/tbody/tr[2]/td[3]/div/div[2]/span");
		select_xpath("/html/body/div/div[3]/div[2]/div/div[4]/table/tbody/tr/td/div[2]/div/div/div/div/table/tbody/tr/td/div/div/div[3]/div[3]/div/table/tbody/tr[3]/td[3]/div/div/span");		
		input("2_config_value", "1");		
		select_xpath("/html/body/div/div[3]/div[2]/div/div[4]/table/tbody/tr/td/div[2]/div/div/div/div/table/tbody/tr/td/div/div/div[3]/div[3]/div/table/tbody/tr[3]/td[3]/div/div[2]/span");
