...
/*		
//hari below three function getting fail ,correct one by one	
...

{
	...
	// select score configuration of ACCOUNTHOLDERNAMEPATTERN_VEL from drop down
	//select_Dropdown_wait("scopeFor", "/html/body/div/div[3]/div[2]/div/div/div/div[2]/div[3]/table/tbody/tr/td[2]/select/option[2]", "ACCOUNTHOLDERNAMEPATTERN_VEL");
	
	// Selecting the Desired drop down value using Javacscript inject 
	//((JavascriptExecutor)driver).executeScript("document.getElementById('scopeFor')[14].selected='true'");
...
@Test(description = "To verify negative check for Fraud Account Negative DB")  
	...
	
	{
		...
		select_Dropdown_wait("checks", "/html/body/div/div[3]/div/div/div[2]/div[2]/table/tbody/tr[2]/td[2]/select/option[6]", "FRAUD_ACCOUNT");
...

{
	...
	// select account holder name DB from negative check drop down
	select_Dropdown_wait("checks", "/html/body/div/div[3]/div/div/div[2]/div[2]/table/tbody/tr[2]/td[2]/select/option[12]", "ZIP_CODE");
