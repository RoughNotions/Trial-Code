...
import com.apc.PGRequestHandle.PGservice.*;
...
public class RestClient {
	...
	public  void consumeRest(String xmlreq, int rownum) {
		...
		try {
			...
			// ankur
			//String PG_API_URL = "https://api.apcld.net/camel/gw";
			//System.out.println("consumeRest() -> THE End URL of PG API is : " + PG_API_URL);
			
			WebResource webResource = client
					.resource(BaseTestPG.Conf.getProperty("PG_API_URL"));
